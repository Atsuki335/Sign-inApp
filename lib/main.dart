      ...
      children: [
        Text('Welcome',
            style: Theme.of(context).textTheme.headlineMedium!.copyWith(
                color: kTextColorPrimary, fontWeight: FontWeight.w500)),
        SizedBox(height: 4),
        Text(
          'Sign in to continue',
  ...
  Widget build(BuildContext context) {
    return TextButton(
      style: TextButton.styleFrom(
          ...
          shape: CircleBorder(side: BorderSide(color: kButtonColorPrimary))),
      onPressed: () {},
      ...
      child: Stack(
        children: [
          ...
          Align(
            alignment: Alignment.topCenter,
            child: Padding(
                padding: EdgeInsets.only(top: 128), child: _HeaderTitle()),
          ),
          Positioned(top: 16, left: 0, child: _HeaderBackButton()),
        ],
      ),
    );
  }
